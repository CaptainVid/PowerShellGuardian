...
& $Cxx @Common "-DMOMENTUM_BRIDGE_CONSOLE" "-mconsole" (Join-Path $ProjectRoot "src\PowerShellGuardian.cpp") "-o" (Join-Path $BuildDirectory "PowerShellGuardianBridge.exe") @Libraries
